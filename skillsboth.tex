\def\titlesoftware{\color{solarized-cyan}Software\color{solarized-violet}(Development)}
\cvsection{\titlesoftware{}{}}
\begin{cventries}
    \cvskill
...
\def\titlesystems{\color{solarized-cyan}Systems\color{solarized-violet}(Engineering)}
\cvsection{\titlesystems{}{}}
\begin{cventries}
    \cvskill
...
\def\titlepersonal{\color{solarized-cyan}Personal\color{solarized-violet}(Projects)}
\cvsection{\titlepersonal{}{}}
\begin{cventries}
	\cvskill
	{Systems Projects}
	{
