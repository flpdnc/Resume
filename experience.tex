...
\begin{cventries}
\cventry
    {Production Engineer - Developer Platform} % Job title
    {Meta, Inc} % Organization
...
\vspace{4mm}
\cventry
    {Production Engineering Manager – Blob Storage} % Job title
    {Meta, Inc} % Organization
    {Remote/Seattle, Washington} % Location
...
\vspace{4mm}
\cventry
    {Production Engineer - Linux Containers Team} % Job title
...
\vspace{4mm}
\cventry
    {Production Engineer - Linux Kernel Team} % Job title
    {Facebook, Inc} % Organization
...
\vspace{4mm}
\cventry
    {Sustaining Linux Systems Engineer} % Job title
    {Facebook, Inc} % Organization
...
\vspace{4mm}
\cventry
    {Site Reliability Operations Engineer} % Job title
    {Facebook, Inc} % Organization
...
\vspace{4mm}
\cventry
    {Hosting Operations Linux Systems Administration} % Job title
