\def\title{\color{solarized-cyan}Job\color{solarized-violet}(Log)}

\cvsection{\title{}{}}
\begin{cventries}
\cventry
	{Production Engineer \color{solarized-orange}(Developer Platform)} % Job title
	{Meta / Facebook, Inc \color{solarized-cyan}(June '10 - January '23)} % Organization
...
\vspace{0mm}
\cventry
	{Production Engineer \color{solarized-orange}(Linux Containers)} % Job title
    {} % Organization
...
\vspace{0mm}
\cventry
	{Production Engineer \color{solarized-orange}(Linux Kernel)} % Job title
    {} % Organization
